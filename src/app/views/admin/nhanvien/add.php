    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="container">
                        <form action="index.php?act=nv&type=add" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="ten_nd">Họ và tên</label>
                                <span class="error"><?= $tenErr??"" ?></span>
                                <input type="text" class="form-control" id="ten_nd" name="ten_nd" placeholder="Nhập tên Admin" value="<?= $_POST["ten_nd"]??"" ?>">
                            </div>
                            ...
                            <?= $message??"" ?>
                            <button type="submit" class="btn btn-primary mb-3" name="addnv" value="addnv">Thêm Admin</button>
                        </form>
                    </div>
                </div>
            </div>
