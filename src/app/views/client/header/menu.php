...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="index.php"><img  style="width: 150px;" src="./public/image/anhsanpham/<?= $shop["anh_shop"] ?>" alt=""></a>
    </div>
    ...
    <nav class="humberger__menu__nav mobile-menu">
        <ul>
            ...
            <li class="active"><a href="index.php">Tin tức</a></li>
...
<header class="header">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <nav  style="margin-top: 50px;" class="header__menu">
                    <ul>
                        <li class="active"><a href="index.php">Trang chủ</a></li>
                        <li class="active"><a href="index.php?act=all">Sản phẩm</a></li>
                        <li class="active"><a href="index.php">Tin tức</a></li>
                        <li class="active"><a href="index.php">Liên hệ</a></li>
                    </ul>
                </nav>
            </div>
            <div class="col-lg-3">
